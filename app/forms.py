...
class AddWorkshop(FlaskForm):
    ...
    vidurl = StringField('Video URL (Youtube / Vimeo)')
    # Take in a pic
    ...
    org = StringField('Organiser Name')
    # orglogo = FileField('Company Logo', validators=[FileAllowed(['jpg', 'png'], 'JPG/PNG Image required')])
